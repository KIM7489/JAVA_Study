...
//// 관리자 페이지 or 사용자 페이지 만들기 
	...
	if(num==3) {
			...
			System.out.println("==========================================================================");
			System.out.println();
			int result2 = intData("1.회원정보 수정 2.도서관리 페이지 3.종료\n");
   if(result2 == 1) {
	   		System.out.println();
			System.out.println();
...
if(num==1) {
			...
			System.out.println("=================================================================================");
			System.out.println();
			int result = intData("1.상품 바로 구매 2.장바구니 담기 3.장바구니 이동");
	...
	if(result == 3) {
			...
			while(true) {	
				// 장바구니 이동 
					...
					int result1 = intData("1. 상품 구매하기 2. ");
					if(result1==1) {
									break;
					} else if(result1 == 2) {
											System.exit(0);
...
//====================================================장바구니 메소드 ========================================================
	public void myBy() { //장바구니 이동
		...
		LasVO dd = LasDataSet.hs2.get(my); 
...
//----------------------------------------------------도서 구매 메소드 ------------------------------------------------------------------------	
	...
	public void bookby() {
			...
			else if(vo.getBooksData() >= booknumber) {
